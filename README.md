...
(NOTE: This might have to be remapped due to a different key being mapped to C, so change that before use.)
...
3. Download Logical Zoom Kotlin from the releases tab.
